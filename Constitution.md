...
Draft positions will be randomized, with at least two owners as witnesses of the random order selection. The picks will be made in a snake fashion, such that the owner with the first pick in the first round will have the last pick in the second round, etc.
